...
static void handleChunk0(int SIZE, hls::burst_maxi<AxiVec16> A,
                         hls::burst_maxi<AxiVec16> B, int c1, int c2) {
  float A_c[3][64];
...
#pragma HLS ARRAY_PARTITION variable = B_c type = complete dim = 2
  ...
  if (SIZE >= 3 && c3 == 0 && c1 % 32 == 0 && c2 % 32 == 0) {
    for (int cc0 = 0; cc0 <= 1; cc0 += 1) {
      int len = 0;
      if ((((-32) + SIZE) <= c2 && c2 < SIZE)) {
        len =
            ((16 * (floor((15 + SIZE) / 16))) - (16 * (floor((15 + c2) / 16))));
      }
      if ((c2 <= ((-33) + SIZE))) {
        len = ((48 + (16 * (floor(c2 / 16)))) - (16 * (floor((15 + c2) / 16))));
      }
  ...
  for (c3 = 0; c3 <= min(31, SIZE - c1 - 3); c3 += 1) {
#pragma HLS PIPELINE

        int c5 = 0;

    // Cache load for A at dim j
    if (SIZE >= 3 && c3 >= 0 && c3 <= 31 && c1 % 32 == 0 && c2 % 32 == 0) {
      int len = 0;
      if ((c2 <= ((-34) + SIZE))) {
        len = ((48 + (16 * (floor(c2 / 16)))) - (16 * (floor((15 + c2) / 16))));
      }
      if ((((-33) + SIZE) <= c2 && c2 < SIZE)) {
        len =
            ((16 * (floor((15 + SIZE) / 16))) - (16 * (floor((15 + c2) / 16))));
      }
    ...
    for (c5 = 0; c5 <= 31; c5 += 1) {
      B_c[0][c5 + 16] =
          0.2 * (A_c[1][c5 + 1 + 16] + A_c[1][c5 + 16] + A_c[1][c5 + 2 + 16] +
                 A_c[2][c5 + 1 + 16] + A_c[0][c5 + 1 + 16]);
    }
    ...
    if (SIZE >= 3 && c3 >= 0 && c3 <= 31 && c1 % 32 == 0 && c2 % 32 == 0) {
      ...
      if ((((-34) + SIZE) <= c2 && c2 <= ((-3) + SIZE))) {
        payLen = (((-2) + SIZE) - c2);
      }
      int leftPad = 0;
      if ((((c2 % 16) == 0) && (((-33) + SIZE) <= c2 && c2 <= ((-3) + SIZE)))) {
        leftPad = 1;
      }
      if ((((c2 % 16) == 0) && (c2 <= ((-34) + SIZE)))) {
        leftPad = 1;
      }
      const int rightPad = (len - payLen) - leftPad;
      const int compLen = len - leftPad;

      B.write_request((c2 + (-1) + 1 + ((c1 + c3 + 1) * SIZE)) / 16, len / 16);

      for (int cc1 = -1; cc1 <= 31; cc1 += 16) {
        if (cc1 < compLen) {
          AxiVec16 t{B_c[0][cc1 + 16], B_c[0][cc1 + 17], B_c[0][cc1 + 18],
                     B_c[0][cc1 + 19], B_c[0][cc1 + 20], B_c[0][cc1 + 21],
                     B_c[0][cc1 + 22], B_c[0][cc1 + 23], B_c[0][cc1 + 24],
                     B_c[0][cc1 + 25], B_c[0][cc1 + 26], B_c[0][cc1 + 27],
                     B_c[0][cc1 + 28], B_c[0][cc1 + 29], B_c[0][cc1 + 30],
                     B_c[0][cc1 + 31]};
