    ...
    for (int cc0 = 0; cc0 <= 1; cc0 += 1) {
      for (int cc1 = 0; cc1 <= 65; cc1 += 1) {
        ...
        if ((((c3 % 64) == 0) && (((-65) + SIZE) <= c3 && c3 < SIZE))) {
          len = ((-c3) + (8 * (floor((448 + (64 * SIZE)) / 512))));
        }
  ...
  for (c4 = 0; c4 <= min(63, SIZE - c1 - 3); c4 += 1) {
    ...
    if (SIZE >= 3 && c4 >= 0 && c4 <= 63 && c6 == 0 && c1 % 64 == 0 &&
      ...
      for (int cc1 = 0; cc1 <= 1; cc1 += 1) {
        ...
        if ((c3 <= ((-65) + SIZE))) {
          len = ((72 + (8 * (floor(c3 / 8)))) - (8 * (floor((7 + c3) / 8))));
        }
      ...
      for (c8 = 0; c8 <= 63; c8 += 1) {
        A1_c[0][0][c8 + 8] =
            (A0_c[1][c6][c8 + 1 + 8] + A0_c[1][c6 + 2][c8 + 1 + 8] +
             ...
             A0_c[0][c6][c8 + 8] + A0_c[0][c6 + 2][c8 + 8] +
             A0_c[2][c6][c8 + 8] + A0_c[2][c6 + 2][c8 + 8] +
             A0_c[1][c6][c8 + 2 + 8] + A0_c[1][c6 + 2][c8 + 2 + 8] +
             A0_c[0][c6 + 1][c8 + 2 + 8] + A0_c[2][c6 + 1][c8 + 2 + 8] +
             A0_c[0][c6][c8 + 2 + 8] + A0_c[0][c6 + 2][c8 + 2 + 8] +
             A0_c[2][c6][c8 + 2 + 8] + A0_c[2][c6 + 2][c8 + 2 + 8] +
