...
static void handleChunk0(int SIZE, hls::burst_maxi<AxiVec16> A,
                         hls::burst_maxi<AxiVec16> B, int c1, int c2, int c3) {
  float A_c[3][66][96];
...
#pragma HLS ARRAY_PARTITION variable = B_c type = complete dim = 3
  ...
  if (SIZE >= 3 && c4 == 0 && c1 % 64 == 0 && c2 % 64 == 0 && c3 % 64 == 0) {
    for (int cc0 = 0; cc0 <= 1; cc0 += 1) {
      for (int cc1 = 0; cc1 <= 65; cc1 += 1) {
        int len = 0;
        if ((c3 <= ((-66) + SIZE))) {
          len =
              ((80 + (16 * (floor(c3 / 16)))) - (16 * (floor((15 + c3) / 16))));
        }
        if ((((-65) + SIZE) <= c3 && c3 < SIZE)) {
        ...
        for (int cc2 = 0; cc2 <= 65; cc2 += 16) {
          if (cc2 < compLen) {
            const AxiVec16 axiTmp = A.read();
            A_c[cc0][cc1][cc2 + 16] = axiTmp.e0;
            A_c[cc0][cc1][cc2 + 17] = axiTmp.e1;
            A_c[cc0][cc1][cc2 + 18] = axiTmp.e2;
            A_c[cc0][cc1][cc2 + 19] = axiTmp.e3;
            A_c[cc0][cc1][cc2 + 20] = axiTmp.e4;
            A_c[cc0][cc1][cc2 + 21] = axiTmp.e5;
            A_c[cc0][cc1][cc2 + 22] = axiTmp.e6;
            A_c[cc0][cc1][cc2 + 23] = axiTmp.e7;
            A_c[cc0][cc1][cc2 + 24] = axiTmp.e8;
            A_c[cc0][cc1][cc2 + 25] = axiTmp.e9;
            A_c[cc0][cc1][cc2 + 26] = axiTmp.e10;
            A_c[cc0][cc1][cc2 + 27] = axiTmp.e11;
            A_c[cc0][cc1][cc2 + 28] = axiTmp.e12;
            A_c[cc0][cc1][cc2 + 29] = axiTmp.e13;
            A_c[cc0][cc1][cc2 + 30] = axiTmp.e14;
            A_c[cc0][cc1][cc2 + 31] = axiTmp.e15;
          }
        }
      }
    }
  ...
  for (c4 = 0; c4 <= min(63, SIZE - c1 - 3); c4 += 1) {

    int c6 = 0;

    // Cache load for A at dim j
    if (SIZE >= 3 && c4 >= 0 && c4 <= 63 && c6 == 0 && c1 % 64 == 0 &&
        c2 % 64 == 0 && c3 % 64 == 0) {
      for (int cc1 = 0; cc1 <= 1; cc1 += 1) {
        int len = 0;
        if ((((-64) + SIZE) <= c3 && c3 < SIZE)) {
          len = ((16 * (floor((15 + SIZE) / 16))) -
                 (16 * (floor((15 + c3) / 16))));
        }
        if ((c3 <= ((-65) + SIZE))) {
        ...
        for (int cc2 = 0; cc2 <= 65; cc2 += 16) {
          if (cc2 < compLen) {
            const AxiVec16 axiTmp = A.read();
            A_c[2][cc1][cc2 + 16] = axiTmp.e0;
            A_c[2][cc1][cc2 + 17] = axiTmp.e1;
            A_c[2][cc1][cc2 + 18] = axiTmp.e2;
            A_c[2][cc1][cc2 + 19] = axiTmp.e3;
            A_c[2][cc1][cc2 + 20] = axiTmp.e4;
            A_c[2][cc1][cc2 + 21] = axiTmp.e5;
            A_c[2][cc1][cc2 + 22] = axiTmp.e6;
            A_c[2][cc1][cc2 + 23] = axiTmp.e7;
            A_c[2][cc1][cc2 + 24] = axiTmp.e8;
            A_c[2][cc1][cc2 + 25] = axiTmp.e9;
            A_c[2][cc1][cc2 + 26] = axiTmp.e10;
            A_c[2][cc1][cc2 + 27] = axiTmp.e11;
            A_c[2][cc1][cc2 + 28] = axiTmp.e12;
            A_c[2][cc1][cc2 + 29] = axiTmp.e13;
            A_c[2][cc1][cc2 + 30] = axiTmp.e14;
            A_c[2][cc1][cc2 + 31] = axiTmp.e15;
          }
        }
      }
    }

    for (c6 = 0; c6 <= min(63, SIZE - c2 - 3); c6 += 1) {
#pragma HLS PIPELINE

          int c8 = 0;

      // Cache load for A at dim k
      if (SIZE >= 3 && c6 >= 0 && c6 <= 63 && c4 >= 0 && c4 <= 63 &&
          c1 % 64 == 0 && c2 % 64 == 0 && c3 % 64 == 0) {
        int len = 0;
        if ((((-64) + SIZE) <= c3 && c3 < SIZE)) {
          len = ((16 * (floor((15 + SIZE) / 16))) -
                 (16 * (floor((15 + c3) / 16))));
        ...
        for (int cc2 = 0; cc2 <= 65; cc2 += 16) {
          if (cc2 < compLen) {
            const AxiVec16 axiTmp = A.read();
            A_c[2][c6 + 2][cc2 + 16] = axiTmp.e0;
            A_c[2][c6 + 2][cc2 + 17] = axiTmp.e1;
            A_c[2][c6 + 2][cc2 + 18] = axiTmp.e2;
            A_c[2][c6 + 2][cc2 + 19] = axiTmp.e3;
            A_c[2][c6 + 2][cc2 + 20] = axiTmp.e4;
            A_c[2][c6 + 2][cc2 + 21] = axiTmp.e5;
            A_c[2][c6 + 2][cc2 + 22] = axiTmp.e6;
            A_c[2][c6 + 2][cc2 + 23] = axiTmp.e7;
            A_c[2][c6 + 2][cc2 + 24] = axiTmp.e8;
            A_c[2][c6 + 2][cc2 + 25] = axiTmp.e9;
            A_c[2][c6 + 2][cc2 + 26] = axiTmp.e10;
            A_c[2][c6 + 2][cc2 + 27] = axiTmp.e11;
            A_c[2][c6 + 2][cc2 + 28] = axiTmp.e12;
            A_c[2][c6 + 2][cc2 + 29] = axiTmp.e13;
            A_c[2][c6 + 2][cc2 + 30] = axiTmp.e14;
            A_c[2][c6 + 2][cc2 + 31] = axiTmp.e15;
          }
        }
      }

      for (c8 = 0; c8 <= 63; c8 += 1) {
        B_c[0][0][c8 + 16] = 0.125 * (A_c[2][c6 + 1][c8 + 1 + 16] -
                                      2.0 * A_c[1][c6 + 1][c8 + 1 + 16] +
                                      A_c[0][c6 + 1][c8 + 1 + 16]) +
                             0.125 * (A_c[1][c6 + 2][c8 + 1 + 16] -
                                      2.0 * A_c[1][c6 + 1][c8 + 1 + 16] +
                                      A_c[1][c6][c8 + 1 + 16]) +
                             0.125 * (A_c[1][c6 + 1][c8 + 2 + 16] -
                                      2.0 * A_c[1][c6 + 1][c8 + 1 + 16] +
                                      A_c[1][c6 + 1][c8 + 16]) +
                             A_c[1][c6 + 1][c8 + 1 + 16];
      }
      ...
      if (SIZE >= 3 && c4 >= 0 && c4 <= 63 && c6 >= 0 && c6 <= 63 &&
          c1 % 64 == 0 && c2 % 64 == 0 && c3 % 64 == 0) {
        int len = 0;
        if ((((-65) + SIZE) <= c3 && c3 <= ((-2) + SIZE))) {
        ...
        if ((((-66) + SIZE) <= c3 && c3 <= ((-3) + SIZE))) {
          payLen = (((-2) + SIZE) - c3);
        }
        int leftPad = 0;
        if ((((c3 % 16) == 0) &&
             (((-65) + SIZE) <= c3 && c3 <= ((-3) + SIZE)))) {
          leftPad = 1;
        }
        if ((((c3 % 16) == 0) && (c3 <= ((-66) + SIZE)))) {
          leftPad = 1;
        }
        ...
        for (int cc2 = -1; cc2 <= 63; cc2 += 16) {
          if (cc2 < compLen) {
            AxiVec16 t{
                B_c[0][0][cc2 + 16], B_c[0][0][cc2 + 17], B_c[0][0][cc2 + 18],
                B_c[0][0][cc2 + 19], B_c[0][0][cc2 + 20], B_c[0][0][cc2 + 21],
                B_c[0][0][cc2 + 22], B_c[0][0][cc2 + 23], B_c[0][0][cc2 + 24],
                B_c[0][0][cc2 + 25], B_c[0][0][cc2 + 26], B_c[0][0][cc2 + 27],
                B_c[0][0][cc2 + 28], B_c[0][0][cc2 + 29], B_c[0][0][cc2 + 30],
                B_c[0][0][cc2 + 31]};
    ...
    // shift
    if (SIZE >= 3 && c4 >= 0 && c4 <= 63 && c1 % 64 == 0 && c2 % 64 == 0 &&
        c3 % 64 == 0) {
      for (int cc0 = 0; cc0 <= 1; cc0 += 1) {
        for (int cc1 = 0; cc1 <= 65; cc1 += 1) {
#pragma HLS UNROLL
          for (int cc2 = 0; cc2 <= 65; cc2 += 1) {
            A_c[cc0][cc1][cc2 + 16] = A_c[cc0 + 1][cc1][cc2 + 16];
          }
        }
      }
    }
