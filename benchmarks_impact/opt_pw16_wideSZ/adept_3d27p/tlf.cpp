  ...
  if (SIZE >= 3 && c4 == 0 && c1 % 64 == 0 && c2 % 64 == 0 && c3 % 64 == 0) {
    for (int cc0 = 0; cc0 <= 1; cc0 += 1) {
      for (int cc1 = 0; cc1 <= 65; cc1 += 1) {
        int len = 0;
        if ((((c3 % 64) == 0) && (0 <= c3 && c3 <= ((-67) + SIZE)))) {
          len = 80;
        }
        if ((((c3 % 64) == 0) && (((-65) + SIZE) <= c3 && c3 < SIZE))) {
          len = ((-c3) + (16 * (floor((960 + (64 * SIZE)) / 1024))));
        }
        if (((c3 == ((-66) + SIZE)) && ((((-2) + SIZE) % 64) == 0))) {
          len = 80;
        }
      ...
      for (c8 = 0; c8 <= 63; c8 += 1) {
        A1_c[0][0][c8 + 16] =
            (A0_c[1][c6][c8 + 1 + 16] + A0_c[1][c6 + 2][c8 + 1 + 16] +
             ...
             A0_c[0][c6][c8 + 16] + A0_c[0][c6 + 2][c8 + 16] +
             A0_c[2][c6][c8 + 16] + A0_c[2][c6 + 2][c8 + 16] +
             A0_c[1][c6][c8 + 2 + 16] + A0_c[1][c6 + 2][c8 + 2 + 16] +
             A0_c[0][c6 + 1][c8 + 2 + 16] + A0_c[2][c6 + 1][c8 + 2 + 16] +
             A0_c[0][c6][c8 + 2 + 16] + A0_c[0][c6 + 2][c8 + 2 + 16] +
             A0_c[2][c6][c8 + 2 + 16] + A0_c[2][c6 + 2][c8 + 2 + 16] +
