...
#pragma HLS ARRAY_PARTITION variable = X_c type = complete dim = 2
  ...
  if (SIZE >= c1 + 3 && c1 >= 0 && SIZE >= c2 + 3 && c2 >= 0 && c1 % 64 == 0 &&
      c2 % 64 == 0) {
    for (int cc0 = 0; cc0 <= min(65, SIZE - c1 - 1); cc0 += 1) {
      int len = 0;
      ...
      for (int cc1 = 0; cc1 <= min(65, SIZE - c2 - 1); cc1 += 8) {
        if (cc1 < compLen) {
...
#pragma HLS PIPELINE
    ...
    for (c5 = 0; c5 <= 63; c5 += 1) {
      X_c[c3][c5 + 8] =
          (A_c[c3 + 1][c5 + 2 + 8] + A_c[c3 + 2][c5 + 2 + 8] +
           A_c[c3 + 2][c5 + 1 + 8] + A_c[c3 + 2][c5 + 8] + A_c[c3 + 1][c5 + 8] +
           A_c[c3][c5 + 8] + A_c[c3][c5 + 1 + 8] + A_c[c3][c5 + 2 + 8]) *
          fac;
    }
  ...
  if (c1 >= 0 && SIZE >= c2 + 3 && c2 >= 0 && c1 % 64 == 0 && c2 % 64 == 0) {
    for (int cc0 = 0; cc0 <= min(63, SIZE - c1 - 3); cc0 += 1) {
      int len = 0;
      if ((((-65) + SIZE) <= c2 && c2 <= ((-2) + SIZE))) {
      ...
      X.write_request((c2 + (-1) + 1 + ((c1 + cc0 + 1) * SIZE)) / 8, len / 8);

      for (int cc1 = -1; cc1 <= min(63, SIZE - c2 - 3); cc1 += 8) {
        if (cc1 < compLen) {
          AxiVec8 t{X_c[cc0][cc1 + 8],  X_c[cc0][cc1 + 9],  X_c[cc0][cc1 + 10],
                    X_c[cc0][cc1 + 11], X_c[cc0][cc1 + 12], X_c[cc0][cc1 + 13],
                    X_c[cc0][cc1 + 14], X_c[cc0][cc1 + 15]};
