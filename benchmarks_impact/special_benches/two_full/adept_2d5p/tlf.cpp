...
#pragma HLS ARRAY_PARTITION variable = X_c type = complete dim = 2
  ...
  if (SIZE >= c1 + 3 && c1 >= 0 && SIZE >= c2 + 3 && c2 >= 0 && c1 % 16 == 0 &&
      c2 % 16 == 0) {
    for (int cc0 = 0; cc0 <= min(17, SIZE - c1 - 1); cc0 += 1) {
      int len = 0;
      ...
      for (int cc1 = 0; cc1 <= min(17, SIZE - c2 - 1); cc1 += 16) {
        if (cc1 < compLen) {
...
#pragma HLS PIPELINE
    ...
    for (c5 = 0; c5 <= 15; c5 += 1) {
      X_c[c3][c5 + 16] = (A_c[c3][c5 + 1 + 16] + A_c[c3 + 2][c5 + 1 + 16] +
                          A_c[c3 + 1][c5 + 2 + 16] + A_c[c3 + 1][c5 + 16]) *
                         fac;
    }
  ...
  if (c1 >= 0 && SIZE >= c2 + 3 && c2 >= 0 && c1 % 16 == 0 && c2 % 16 == 0) {
    for (int cc0 = 0; cc0 <= min(15, SIZE - c1 - 3); cc0 += 1) {
      int len = 0;
      if ((((-17) + SIZE) <= c2 && c2 <= ((-2) + SIZE))) {
        len =
      ...
      X.write_request((c2 + (-1) + 1 + ((c1 + cc0 + 1) * SIZE)) / 16, len / 16);

      for (int cc1 = -1; cc1 <= min(15, SIZE - c2 - 3); cc1 += 16) {
        if (cc1 < compLen) {
          AxiVec16 t{X_c[cc0][cc1 + 16], X_c[cc0][cc1 + 17], X_c[cc0][cc1 + 18],
                     X_c[cc0][cc1 + 19], X_c[cc0][cc1 + 20], X_c[cc0][cc1 + 21],
                     X_c[cc0][cc1 + 22], X_c[cc0][cc1 + 23], X_c[cc0][cc1 + 24],
                     X_c[cc0][cc1 + 25], X_c[cc0][cc1 + 26], X_c[cc0][cc1 + 27],
                     X_c[cc0][cc1 + 28], X_c[cc0][cc1 + 29], X_c[cc0][cc1 + 30],
                     X_c[cc0][cc1 + 31]};
